...
\begin{enumerate}
\item $E$を, \eref{eq:grav_work_mgh}と\eref{eq:work_gravity}のそれぞれを用いて表せ（前者を$E_1$, 後者を$E_2$とする。地球を半径$R=6370$~km, 質量$M=5.972\times 10^{24}$~kgの球とし, 重力加速度を$g=9.823$~m~s$^{^2}$とする。物体に働く力は重力以外の力, 例えば自転による遠心力などは考えない）。
...
ポテンシャルエネルギーの絶対値である
$1.602\times 10^{-19}$~Jは, 1~eVと呼ばれる。\underline{eV}\index{eV}は
...
\noindent{\textbf{答}}\ref{q:moveup_work} (略解)
\begin{enumerate}
...
\end{eqnarray*}
これらを\eref{eq:potential_gravity}に代入して, $U=-7.3\times 10^{28}$ J。
（ただし無限遠を基準点とする。）
\end{enumerate}
\mv
...
$Q=1.602\times 10^{-19}$~C。また, \eref{eq:coulomb}より, 
